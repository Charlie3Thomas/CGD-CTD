...
inline Scene cornell_box
{
    ...
    {        
        ...
        {
            /* point light 1 */
            //{ .colour = WHITE * 25.0F, .position  = Eigen::Vector3f{ 0.0F, 2.4F, 5.0F } },
            /* point light 2 */
            //{ /* point light properties */ }
        },
        /* area_cuboid */
    ...
    // PLANES
        ...
        /* GROUND_1 */
        { "/home/Charlie/CGD-CTD/obj/plane.obj", 2.5F, Eigen::Matrix3f(MakeRotation(0.0F, 0.0F, 0.0F)    * 2.5F), Eigen::Vector3f(0.0F, -2.5F, 5.0F), EmbreeSingleton::GetInstance().materials["white_d"].get(), nullptr },
        /* CEILING_1 */
        { "/home/Charlie/CGD-CTD/obj/plane.obj", 2.5F, Eigen::Matrix3f(MakeRotation(0.0F, 180.0F, 180.0F)  * 2.5F), Eigen::Vector3f(0.0F, 2.5F, 5.0F), EmbreeSingleton::GetInstance().materials["white_d"].get(), nullptr },
        /* LEFT WALL_1 */
        ...
        /* CEILING_2 */
        { "/home/Charlie/CGD-CTD/obj/plane.obj", 2.5F, Eigen::Matrix3f(MakeRotation(0.0F, 180.0F, 180.0F)  * 2.5F), Eigen::Vector3f(0.0F, 2.5F, 0.0F), EmbreeSingleton::GetInstance().materials["white_d"].get(), nullptr },
        /* LEFT WALL_2 */
...
inline Scene triple_statue_area_light
{
    ...
    /* lights */
    {
        ...
        {
            /* area light cuboid 1 */
            { WHITE * 10.0F, Eigen::Vector3f(0.0F, 5.0F, 10.0F), Eigen::Vector3f(0.0F, -1.0F, 0.0F), 1.0F, 1.0F }
        },
        /* area_sphere */
        {
            /* area light sphere 1 */
