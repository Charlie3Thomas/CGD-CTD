...
def objective_function(params, render_time_list, time_weight):
    ...
    try:
        ...
        #if "l1_difference" not in locals():
        #    l1_difference = float('inf')
...
def test_guess():
    initial_guess = [1.0, 0.373387, 0.793112]
    return np.array(initial_guess)
...
def main():
    ...
    for time_weight in time_weights:
        ...
        for attempt_num in range(num_attempts):
            ...
            for iteration, (best_vertex, objective_value, direct_samples, indirect_samples, recursion_depth, render_time, l1_difference) in enumerate(results, 1):
                ...
                json_data["render_time"].append(render_time)
                json_data["L1_difference"].append(l1_difference)
                json_data["objective_value"].append(objective_value + time_weight * render_time)
        ...
        objective_function(best_params, [], time_weight)     
